...
switch(x,
       VERMOS_project = { 
         url <-"https://raw.githubusercontent.com/ChrisWudel/point-pattern-reconstruction/main/Records/Individual_tree_data_5138_Wudel%20et%20al.%2C%202022_doi.org_10.5281_zenodo.7157076.csv"
       ...
       Northwest_German_Forest_Research_Institute = { 
         url <-"https://raw.githubusercontent.com/ChrisWudel/point-pattern-reconstruction/main/Records/stammv_3002j_Spellmann%2C%202022_doi.org_10.5281_zenodo.7124817.csv"
         data <- read.csv(url,sep = ",", stringsAsFactors = TRUE)
       ...
       Marteloscope_data_from_the_by_the_Chair_of_Forest_Growth_and_Woody_Biomass_Production = { 
         url <-"https://raw.githubusercontent.com/ChrisWudel/point-pattern-reconstruction/main/Records/Marteloscope_710_b1_Fichtner%20and%20van%20der%20Maaten-Theunissen%2C%202022_doi.org_10.5281_zenodo.7147868.csv"
         data <- read.csv(url,sep = ",", stringsAsFactors = TRUE)
